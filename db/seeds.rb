...
Stock.create(name: "Apple", label:"APLE", price: 150, previous: 150, description:"Invest in the real sauce.")
Stock.create(name: "Banana", label:"BAN", price: 125, previous: 125, description:"The Stock That's Never Bruised!")
Stock.create(name: "Cherry", label:"CIER", price: 55, previous: 55, description:"The best fruit.")
Stock.create(name: "Watermelon", label:"H2O", price: 200, previous: 200, description:"Earth is just 75% watermelon.")
Stock.create(name: "Pear", label:"P", price: 22, previous: 22, description:"Green watery and not quite watermelon.")
